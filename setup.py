...
setup(
    ...
    name='flasklogin_tutorial',  # Required
    ...
    description='Example Flask project for implementing Flask-Login.',  # Optional
    ...
    url='https://github.com/toddbirchard/flasklogin-tutorial',  # Optional
